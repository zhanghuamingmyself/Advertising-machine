package com.wifi.getFile.net;

import android.os.Message;
import android.util.Log;

import com.wifi.getFile.Data.ChatMessage;
import com.wifi.getFile.Data.User;
        ...
        while(onWork){
            ...
            switch(commandNo2){
                case IpMessageConst.IPMSG_BR_ENTRY:	{	//收到上线数据包，添加用户，并回送IPMSG_ANSENTRY应答。
                    ...
                    WiFIBaseActivity.sendEmptyMessage(IpMessageConst.IPMSG_BR_ENTRY);
                ...
                case IpMessageConst.IPMSG_ANSENTRY:	{	//收到上线应答，更新在线用户列表
                    ...
                    WiFIBaseActivity.sendEmptyMessage(IpMessageConst.IPMSG_ANSENTRY);
                }
                break;
                ...
                case IpMessageConst.IPMSG_BR_EXIT:{	//收到下线广播，删除users中对应的值
                    ...
                    users.remove(userIp);
                    WiFIBaseActivity.sendEmptyMessage(IpMessageConst.IPMSG_BR_EXIT);
                ...
                case IpMessageConst.IPMSG_SENDMSG:{ //收到消息，处理
                    ...
                    if((commandNo & IpMessageConst.IPMSG_FILEATTACHOPT) == IpMessageConst.IPMSG_FILEATTACHOPT){
                        ...
                        WiFIBaseActivity.sendMessage(msg);
                    ...
                    if(!receiveMsg(msg)){	//没有聊天窗口对应的activity
                        ...
                        WiFIBaseActivity.playMsg();
                        //之后可以做些UI提示的处理，用sendMessage()来进行，暂缺
                        WiFIBaseActivity.sendEmptyMessage(IpMessageConst.IPMSG_SENDMSG);	//更新主界面UI
                    }
                ...
                case IpMessageConst.IPMSG_RELEASEFILES:{ //拒绝接受文件
                    WiFIBaseActivity.sendEmptyMessage(IpMessageConst.IPMSG_RELEASEFILES);
                }
                break;
